...
didelis, tai duota reikšmė turi daug įtakos rezutatui. \cite{salt2}
\par
...
apvalinama į begalybę. \cite{salt7}
...
gerai jeigu duomenų yra itin daug. \cite{salt8} Tokiu atveju reiktų daug atminties. Šis algoritmas nebus naudojamas, nes nėra
...
nes MSE yra antrojo laipsnio funckija. \cite{salt12}
...
klasė. Su kiekvienu uždaviniu yra patartina patiems apsibrėžti kokios formos turi būti inkarai. \cite{salt15}
...
toliau analizuojami. \cite{salt15} Kiekvienam kirtimuisi yra apskaičiuojamas kirtimosi koficientas:
\[
