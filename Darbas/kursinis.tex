...
lūžiai ir taip toliau \cite{salt23}. Mano darbo tikslas yra prisidėti prie programinės įrangos kūrimo radiologams
ir sukurti programą, kuri aptinka plaučius, kad vėliau tai galėtų būti panaudota tolimesnei
IT plėtrai medicinos srityje. Darbe yra siekiama sukurti modelį, kuris aptikis
plaučius kompiuterinės tomografijos nuotraukose,
\par
...
Šiame darbe kalbėsiu apie vieną iš šių metodų: dirbtinius neuroninius tinklus.
...
Dabartinė mokslinė veikla, nagrinėjanti dirbtinių neuroninų tinklų veiklą,
fokusuojasi ties sunkiai aptinkamos duomenų koreliacijos aptikimo
automatizacijos \cite{salt24}.
Tačiau net ir jiems ši užduotis yra per sudėtinga, jeigu
...
Pasirinktam mano dirbtinių neuroninių tinklų metodui, vienas iš galimų alternatyvų yra \enquote{sprendimo medžiai}.
...
Modelio tikslumui didinti, jį reikia apmokyti jam reikia įvesties parametrus
ir tikslius rezultatus. Dirbtiniai neuroninių tinklų modelio pavadinimas
kilo iš biologinės modelio prigimties: modelį sudaro neuronai
ir jie tarpusavyje saveikauja. Modelio apmokymas taip pat primena 
smegenų veiklą \cite{salt24}. Modeliui yra duodama daug duomenų pavyzdžių, norimi rezultatai ir jis aptinka
...
\begin{enumerate}
  ...
  Mokymosi sparta ir šios tikimybės dydis priklauso nuo pačios aktyvacijos funkcijos. 
...
\enquote{p} ir spėjamos \enquote{q} yra apskaičiuojama pagal:
...
vienetų \enquote{x}, su \enquote{w} svoriais. Visi šie neuroniai savo ir kaimyniniuose dviejuose sluoksniuose
...
\item Optimizavimo funkcijos \enquote{užstrigimas} ties lokaliu minimumu. Optimizavimo funkcijų tinklas yra rasti
...
\]
\par
Huber nuostolių funkcija yra mažiau žinoma nei kitos ir mažiau naudojama
