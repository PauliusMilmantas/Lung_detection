...
sukūrimą, ištreniravimą ir jo praktinį pritaikymą programoje.
...
Kiekvienai nuotraukai buvo pritaikytas Gauso filtas su 5 skirtingais
...
yra skirta apmokymui ir patikrinimui kaip veikia vaizdų klasifikacijos
...
\par
Nusistačius koks modelis bus naudojamas, reikia jį sukonfiguruoti.
...
Kadangi šiame darbe yra birbama tik su plaučių aptikimu, klasių yra tik 1.
...
branduolio dydis, lygus 2. Konfiguriaciniame faile taip pat yra nurodoma naudojama
...
konfiguracinį failą, duotus suspaustus duomenis, modelį ir treniruoja tinklą.
...
kuri aptinka objektus kompiuterinės topomgrafijos nuotraukose. Apmokyti tinklą
