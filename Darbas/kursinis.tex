...
\begin{enumerate}
  ...
  kuris parodo kokia tikimybė, kad objektas atitinka tam tikrą klasę.
  ...
  \item Optimizatimo funkcija: optimizuoja tikslo funkciją.
...
didelis, tai duota reikšmė turi daug įtakos rezultatui. \cite{salt2}
\par
...
Funkcija yra bloai apibrėžta, jeigu keičiant funkcijos įvestį nedaug, funkcijos reikšmė
