...
flags.DEFINE_string('tfrecord_filename', 'train.record', 'Name of TFRecord file')
...
def main(_):
  ...
  print("images_dir_path" + ": " + str(images_dir_path))
  print("annotations_dir_path" + ": " + str(annotations_dir_path))
  print("tfrecord_dir_path" + ": " + str(tfrecord_dir_path))
  print("label_map_dict" + ": " + str(label_map_dict))
  print("images_filename" + ": " + str(images_filename))
